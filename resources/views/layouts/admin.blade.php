...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="ad/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="ad/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="ad/nprogress.css" rel="stylesheet">
    <!-- jQuery custom content scroller -->
    <link href="ad/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
    <!-- Custom Theme Style -->
  ...
  <body class="nav-md">
    ...
    <!-- jQuery -->
    <script src="ad/js/jquery.min.js"></script>
    <!-- Bootstrap -->
   <script src="ad/js/bootstrap.bundle.min.js"></script>
    <!-- FastClick -->
    <script src="ad/js/fastclick.js"></script>
    <!-- NProgress -->
    <script src="ad/js/nprogress.js"></script>
    <!-- jQuery custom content scroller -->
    <script src="ad/js/jquery.mCustomScrollbar.concat.min.js"></script>
